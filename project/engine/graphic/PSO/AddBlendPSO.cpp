...
void AddBlendPSO::Initialize(DirectXCommon* dxCommon)
{
	assert(dxCommon);
	dxCommon_ = dxCommon;
...
void AddBlendPSO::DrawSettingsCommon()
{
	/*ルートシグネイチャをセットするコマンド*/
	 //RootSignatureを設定。
...
void AddBlendPSO::CreateRootSignature()
{
...
void AddBlendPSO::CreateGraphicPipeline()
{
	//ルートシグネイチャ」の作成
	CreateRootSignature();
