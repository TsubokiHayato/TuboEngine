...
void MultiplyBlendPSO::Initialize(DirectXCommon* dxCommon)
{
	assert(dxCommon);
	dxCommon_ = dxCommon;
...
void MultiplyBlendPSO::DrawSettingsCommon()
{
	/*ルートシグネイチャをセットするコマンド*/
	 //RootSignatureを設定。
...
void MultiplyBlendPSO::CreateRootSignature()
{
...
void MultiplyBlendPSO::CreateGraphicPipeline()
{
	//ルートシグネイチャ」の作成
	CreateRootSignature();
