...
void ScreenBlendPSO::Initialize(DirectXCommon* dxCommon)
{
	assert(dxCommon);
	dxCommon_ = dxCommon;
...
void ScreenBlendPSO::DrawSettingsCommon()
{
	/*ルートシグネイチャをセットするコマンド*/
	 //RootSignatureを設定。
...
void ScreenBlendPSO::CreateRootSignature()
{
...
void ScreenBlendPSO::CreateGraphicPipeline()
{
	//ルートシグネイチャ」の作成
	CreateRootSignature();
